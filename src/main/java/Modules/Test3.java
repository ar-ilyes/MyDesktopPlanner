...
public class Test3 {
    public static void main(String[] args) {
        ...
        //the tasks
        TacheSimple tache1 = new TacheSimple("test2Tache", 30, creneau1, Priorite.LOW, LocalDate.of(2020, 1, 4), new Categorie("Study"), Couleur.BLEU, Etat.In_Progress, Etat_realisation.EN_COURS, 0);
        TacheSimple tache2 = new TacheSimple("test2Tache2", 50, creneau2, Priorite.LOW, LocalDate.of(2020, 1, 4), new Categorie("Study"), Couleur.BLEU, Etat.In_Progress, Etat_realisation.EN_COURS, 0);
        TacheSimple tache3 = new TacheSimple("test2Tache3", 30, creneau2, Priorite.HIGH, LocalDate.of(2020, 1, 4), new Categorie("Study"), Couleur.BLEU, Etat.In_Progress, Etat_realisation.EN_COURS, 0);
        TacheSimple tache4 = new TacheSimple("test2Tache4", 30, creneau2, Priorite.MEDIUM, LocalDate.of(2020, 1, 4), new Categorie("Study"), Couleur.BLEU, Etat.In_Progress, Etat_realisation.EN_COURS, 0);
        ...
        System.out.println("Periode :"+calendrier.getPeriodeDebut());
        System.out.println("");
        System.out.println("Periode :"+calendrier.getPeriodeFin());
